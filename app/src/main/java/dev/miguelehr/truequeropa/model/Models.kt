...
data class Product(val id:String, val ownerId:String, val titulo:String, val descripcion:String, val talla:Size, val estado:Condition, val categoria:Category, val imageUrl:String, val color:String? = null)
